...
export function NavPc({ darkModeActive }) {
  ...
  const line1 = menuOpen
    ? 'div__menu--line1 div__menu--line1 AnimateLine1'
    : 'div__menu--line1';
  const line2 = menuOpen
    ? 'div__menu--line1 div__menu--line1 AnimateLine2'
    : 'div__menu--line2';
  const line3 = menuOpen
    ? 'div__menu--line1 div__menu--line1 AnimateLine3'
    : 'div__menu--line3';
  ...
  const classNameNav = darkModeActive
    ? 'main__header dark__mode--ligth-header'
    : 'main__header';
      ...
      <nav className='header__nav'>
        ...
        <ul className='nav__ul'>
          <li>
            <a
              href='#home'
              className={redirectedHome}
              onClick={HandleClicRedirectHome}
            >
              HOME
            </a>
          </li>
          <li>
            <a
              href='#about'
              className={redirectedAbout}
              onClick={HandleClicRedirectAbout}
            >
              ABOUT
            </a>
          </li>
          <li>
            <a
              href='#projects'
              className={redirectedProjects}
              onClick={HandleClicRedirectProjects}
            >
              PROJECTS
            </a>
          </li>
          <li>
            <a
              href='#contact'
              className={redirectedContact}
              onClick={HandleClicRedirectContact}
            >
              CONTACT
            </a>
          </li>
